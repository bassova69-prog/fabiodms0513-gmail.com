...
import { Home, Music, GraduationCap, Briefcase, Lock, Unlock, TrendingUp, DollarSign, Scale, FileText, Calendar, PieChart, UploadCloud, FileDigit, ShieldAlert } from 'lucide-react';
  ...
  return (
    <aside className="fixed left-0 top-14 w-60 h-[calc(100vh-56px)] bg-[#0f0f0f] border-r border-[#3d2b1f] overflow-y-auto z-40 pr-2 pb-4 hidden md:flex flex-col custom-scrollbar">
      <div className="flex flex-col pt-3 flex-1">
        ...
        {isAdmin && (
            <div className="px-4 mt-6 animate-in slide-in-from-bottom-2 duration-500">
